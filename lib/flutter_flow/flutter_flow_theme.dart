...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF4D51);
  late Color secondary = const Color(0xFFB82528);
  late Color tertiary = const Color(0xFFFF0009);
  late Color alternate = const Color(0xFF720003);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF373737);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFAAAAAA);
