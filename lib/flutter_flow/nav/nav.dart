...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            ...
            asyncParams: {
              'document': getDoc(['Post'], PostRecord.fromSnapshot),
            },
        ...
        FFRoute(
          name: OrganiserprofileWidget.routeName,
          path: OrganiserprofileWidget.routePath,
          builder: (context, params) => OrganiserprofileWidget(),
        ),
        FFRoute(
          name: OrganisereventsWidget.routeName,
          path: OrganisereventsWidget.routePath,
          builder: (context, params) => OrganisereventsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
            name: FindFriendsWidget.routeName,
            path: FindFriendsWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: FindFriendsWidget(),
                )),
        FFRoute(
            ...
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: MytIcketsWidget(),
                )),
        FFRoute(
            name: AmyUserPageWidget.routeName,
            path: AmyUserPageWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: AmyUserPageWidget(),
                )),
        FFRoute(
            name: TomUserPageWidget.routeName,
            path: TomUserPageWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: TomUserPageWidget(),
                )),
        FFRoute(
            name: JessUserPageWidget.routeName,
            path: JessUserPageWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: JessUserPageWidget(),
                ))
