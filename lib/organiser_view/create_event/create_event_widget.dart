...
class _CreateEventWidgetState extends State<CreateEventWidget> {
  ...
  void initState() {
    ...
    _model.priceTextController ??= TextEditingController(text: '£');
                                                    ...
                                                    onTap: () async {
                                                      ...
                                                      if (selectedMedia !=
                                                        ...
                                                        try {
                                                          ...
                                                          _model.isDataUploading_dataUpload =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFile_dataUpload =
                                                                selectedUploadedFiles
                                                                    .first;
                                                            _model.uploadedFileUrl_dataUpload =
                                                                downloadUrls
                                                                    .first;
                                                          });
                                                        } else {
                                                    ...
                                                    child: ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              4.0),
                                                      child: Image.network(
                                                        'https://images.unsplash.com/photo-1601027847350-0285867c31f7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw2fHxxdWVzdGlvbiUyMG1hcmt8ZW58MHx8fHwxNzY1OTAxODY5fDA&ixlib=rb-4.1.0&q=80&w=1080',
                                                        width: 300.0,
                                                        height: 190.0,
                                                        fit: BoxFit.fitWidth,
                                                      ),
                                      ...
                                      children: [
                                        ...
                                        FlutterFlowChoiceChips(
                                          ...
                                          selectedChipStyle: ChipStyle(
                                            backgroundColor: Color(0xFF6F0E24),
                                            textStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                                    .override(
                        ...
                        onPressed: () async {
                          ...
                          await postRecordReference.set({
                            ...createPostRecordData(
                              postTitle: _model.productNameTextController2.text,
                              postDescription:
                                  _model.descriptionTextController.text,
                              category: _model.choiceChipsValue,
                              price: double.tryParse(
                                  _model.priceTextController.text),
                              postPhoto: _model.uploadedFileUrl_dataUpload,
                              postUser: currentUserReference,
                              location: _model.productNameTextController2.text,
                          ...
                          _model.newRefEvent = PostRecord.getDocumentFromData({
                            ...createPostRecordData(
                              postTitle: _model.productNameTextController2.text,
                              postDescription:
                                  _model.descriptionTextController.text,
                          ...
                          await currentUserReference!.update({
                            ...mapToFirestore(
                              {
                                'events_posted': FieldValue.arrayUnion(
                                    [_model.newRefEvent?.reference]),
                              },
                            ),
                          });
