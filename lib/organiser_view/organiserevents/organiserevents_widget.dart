...
import 'organiserevents_model.dart';
export 'organiserevents_model.dart';

class OrganisereventsWidget extends StatefulWidget {
  const OrganisereventsWidget({super.key});

  static String routeName = 'Organiserevents';
  static String routePath = '/organiserevents';

  @override
  State<OrganisereventsWidget> createState() => _OrganisereventsWidgetState();
}

class _OrganisereventsWidgetState extends State<OrganisereventsWidget> {
  late OrganisereventsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrganisereventsModel());
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'All your event are listed here',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 8.0, 4.0, 8.0),
                                            child: Text(
                                              columnPostRecord.price.toString(),
