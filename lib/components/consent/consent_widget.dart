  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFD23958),
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 50.0, 16.0, 0.0),
                              child: Text(
                                'By signing up, you agree to our Terms of Service and Privacy Policy, and consent to the secure processing of your personal data to provide app services.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
